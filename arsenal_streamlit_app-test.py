...
opt = st.sidebar.selectbox("Arsenal FC Project", 
...
# Containers
objective = st.container()
the_data_story = st.container()
the_dataset = st.container()
cleaning_the_data = st.container()
exploring_the_data = st.container()
machine_learning = st.container()
analysing_the_results = st.container()
understanding_the_results = st.container()
...
if opt == "Objective" or opt is None:
    with objective:    
...
if opt == "Cleaning the Data":
    with cleaning_the_data:   
...
if opt == "Exploring the Data":
    with exploring_the_data:       
...
if opt == "Analysing the Results":
    with analysing_the_results:        
...
if opt == "Understanding the Results":
    with understanding_the_results:       
